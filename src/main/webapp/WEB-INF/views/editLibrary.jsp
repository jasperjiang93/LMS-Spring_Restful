...
<div class="container" align="center">
    <h3>Hello Admin - Enter Library Details.</h3>
    <form action="editLibrary" method="post">
        <p>Enter Library Name</p>
        <input type="text" name="libraryName" required="required" value="<%=library.getLibraryName() %>"> <br />
        <p>New Address</p>
        <input type="text" name="libraryAddress" value="<%=library.getLibraryAdderess() %>"> <br />
        <input type="hidden" name="libraryId" value="<%=library.getLibraryId() %>">
        <br>
