...
<%
	...
	if (request.getAttribute("authors") != null) {
		...
		authors = service.readAuthors(1, null);
	}
	...
	<div class="container-fluid">
		<%--<nav aria-label="Page navigation">--%>
			...
			<%--<input type="text" class="form-control"--%>
				   ...
				   <%--aria-describedby="basic-addon1" name="searchString" id="searchString" oninput="searchAuthors()">--%>
			<%--</div>--%>
		...
		<%--</nav>--%>
            <div class="row">
                ...
                <div class="col-lg-8">		<table class="table table-striped" id="authorsTable" >
                    <tr>
                        <th>#</th>
                        <th>Author Name</th>
                        <th>Books Written</th>
                ...
                <div class="col-xs-4">
                    <form action="addAuthor" method="post">
                        <p>Enter a new Author Name</p> <input type="text" style="width:200px" required="required" name="authorName"> <br />
                        <p>Select one or more books to associate your Author:</p>
                        <select style="width:200px" name="bookIds" multiple="multiple" size="5">
                            <%
                                for (Book b : allBooks) {
                            %>
