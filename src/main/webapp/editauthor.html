...
<div class="container" align="center">
	<h3>Hello Admin - Enter New Author Details.</h3>
	<form action="editAuthor" method="post">
		<p>Enter Author Name</p>
		<input type="text" name="authorName" required="required"    value="<%=author.getAuthorName() %>"> <br />
		<input type="hidden" name="authorId" value="<%=author.getAuthorId() %>">
		<br>
		<button type="submit" class="btn btn-sm btn-warning">Edit Author</button>
	</form>
</div>
</body>
</html>
